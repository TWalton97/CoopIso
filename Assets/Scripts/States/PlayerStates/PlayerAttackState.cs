...
public class PlayerAttackState : PlayerBaseState
{
    ...
    public override void OnEnter()
    {
        ...
        if (player.attackStateMachine.previous.State == player.blockState && player.WeaponController.instantiatedPrimaryWeapon != null && player.WeaponController.instantiatedPrimaryWeapon.weaponRangeType == WeaponRangeType.Ranged)
        {

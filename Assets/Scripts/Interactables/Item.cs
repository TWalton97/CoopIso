...
public class ItemData
{
    ...
    public int GoldValue => Mathf.RoundToInt(ItemSO.GoldValue * QualityTables.QualitySellMultiplier[Quality] * (1 + (socketedGems.Count * 0.4f)));
    ...
    public int ShieldArmorAmount => (ItemSO as ShieldSO)?.ArmorAmount != null ? Mathf.FloorToInt((ItemSO as ShieldSO).ArmorAmount * QualityTables.QualityStatMultiplier[Quality]) : 0;
